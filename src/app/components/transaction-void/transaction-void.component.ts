...
@Component({
  selector: "app-transaction-void",
  templateUrl: "./transaction-void.component.html",
  styleUrls: ["./transaction-void.component.css"],
  providers: [
    {
      provide: DateAdapter,
...
export class TransactionVoidComponent {
  store_code: any;
  store_name: any;
  storeData: any = [];
  ...
  constructor(
    ...
    this.authService.login().subscribe((result) => {
      ...
      if (result && result.access_token) {
        ...
        this.transactionVoid(this.fromDate, this.toDate);
      }
    });
  }
  formFieldsAdded() {
  ...
  applyDateFilter() {
    this.transactionVoid(this.searchFrom, this.searchTo);
  }
  ...
  transactionVoid(fromDate: any, toDate: any) {
    this.loadingSpinner = true;
    this.appService
      .transactionVoid("json", fromDate, toDate, this.storeIdValue)
      .subscribe((result) => {
